      ...
      <section className="py-16 bg-gradient-to-br from-pankh-navy to-pankh-navy-light text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 bg-white/5 backdrop-blur-sm p-6 rounded-xl">
              <h3 className="text-xl font-bold text-pankh-gold mb-4">Target Geographies</h3>
              <p className="text-gray-200">
                • Tier 2 cities: Lucknow, Indore, Jaipur, Bhopal, Varanasi, Ranchi, Jamshedpur<br />
                • Tier 3 cities and semi-urban towns across UP, MP, Rajasthan, Jharkhand, Bihar<br />
                • Young working professionals in IT/services sector outside metros<br />
                • Small business owners and self-employed individuals aged 28–50
              </p>
            </div>
          </div>
        </div>
