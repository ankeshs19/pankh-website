        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Retirement Planning */}
              <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition border-2 border-pankh-navy/10">
                <div className="flex items-center mb-6">
                  <div className="text-5xl mr-4">🏖️</div>
                  <h2 className="text-3xl font-bold text-pankh-navy">Retirement Planning</h2>
                </div>
              ...
              {/* Future Planning */}
              <div className="bg-gradient-to-br from-yellow-50 to-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition border-2 border-pankh-gold/20">
                <div className="flex items-center mb-6">
                  <div className="text-5xl mr-4">🎓</div>
                  <h2 className="text-3xl font-bold text-pankh-navy">Future Planning</h2>
                </div>
