...
${formData.message}
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              {/* Contact Information */}
              <div>
                <h2 className="text-3xl font-bold text-pankh-navy mb-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="bg-pankh-gold/10 p-3 rounded-lg mr-4">
                      <svg className="w-6 h-6 text-pankh-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Office Hours */}
                <div className="mt-8 bg-pankh-gold/10 p-6 rounded-xl">
                  <h3 className="font-semibold text-pankh-navy mb-3">Office Hours</h3>
              ...
              <div className="bg-gray-50 p-5 sm:p-8 rounded-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-pankh-navy hover:bg-pankh-navy-light text-white font-semibold py-3 px-6 rounded-lg transition flex items-center justify-center space-x-2"
                  >
      ...
      {/* Quick Contact CTA */}
      <section className="py-12 bg-pankh-navy text-white">
