...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-pankh-navy to-pankh-navy-light text-white py-20 md:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-pankh-gold">Har ummeed ko Pankh,</span><br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/contact" 
                className="bg-pankh-gold hover:bg-pankh-gold-light text-pankh-navy font-semibold px-8 py-4 rounded-full transition text-lg"
              >
                Start Your Journey
              </Link>
              <Link 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              <div className="text-4xl font-bold text-pankh-navy mb-2">300M+</div>
            ...
            <div className="p-6">
              <div className="text-4xl font-bold text-pankh-navy mb-2">95%+</div>
            ...
            <div className="p-6">
              <div className="text-4xl font-bold text-pankh-navy mb-2">~5%</div>
      ...
      <section className="py-20 bg-gradient-to-br from-pankh-navy to-pankh-navy-light text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contact" 
              className="bg-pankh-gold hover:bg-pankh-gold-light text-pankh-navy font-semibold px-8 py-4 rounded-full transition text-lg inline-block"
            >
              Get Started Today
            </Link>
            <a 
              ...
              className="bg-green-500 hover:bg-green-600 text-white font-semibold px-8 py-4 rounded-full transition text-lg inline-flex items-center justify-center space-x-2"
            >
